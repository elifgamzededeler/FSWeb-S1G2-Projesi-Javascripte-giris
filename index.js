...
function kopeginYasi(insanYasi) {
  kopekyasi = insanYasi / 7;
  console.log(kopekyasi);
  return kopekyasi;
}
...
function cocukSarkisi(maymunsayisi) {
  for (let i = 0; i < maymunsayisi; i++) {
    console.log(maymunsayisi - i + "küçük maymun yatakta zıplamış");
  }
  return true;
}
